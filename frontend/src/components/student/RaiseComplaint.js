  ...
  return (
    <div className="container-fluid" style={{
      ...
      <div className='d-flex justify-content-center'>
        <h2 className="text-center mb-4 border border-dark rounded" style={{ color: '#023D54', width: "50rem" }}>
          Raise a Complaint
        </h2>
      </div>
      <div className='d-flex justify-content-center'>
        <form onSubmit={handleRaiseComplaint} className="border border-dark rounded p-4" style={{ background: '#F2F8F1', width: "50rem" }}>
          ...
          <button type="submit" className="btn btn-primary mt-3" style={{ backgroundColor: '#023D54', borderColor: '#023D54' }}>
            Raise Complaint
          </button>
        </form>
      </div>
